...
export const PlayerProvider = ({ children }) => {
  ...
  useEffect(() => {
    if (currentSong) {
      console.log('[PlayerContext] Definindo audioUrl:', currentSong.audioUrl);
      if (!currentSong.audioUrl) {
        console.warn('[PlayerContext] audioUrl da música está vazio:', currentSong);
      }
      audioRef.current.src = currentSong.audioUrl;
      audioRef.current.load();
      audioRef.current.onloadeddata = () => {
        console.log('[PlayerContext] Áudio carregado com sucesso:', currentSong.audioUrl);
      };
      audioRef.current.onerror = (e) => {
        console.error('[PlayerContext] Erro ao carregar áudio:', e, currentSong.audioUrl);
      };
      if (isPlaying) {
        audioRef.current.play().catch(err => console.error('[PlayerContext] Erro ao dar play:', err, currentSong.audioUrl));
      }
    }
  }, [currentSong]);
