    ...
    <div className="md:hidden fixed inset-0 bg-black/90 text-white flex flex-col z-50 transition-all duration-300 ease-in-out">
      ...
      <div className="flex items-center justify-between px-4 py-4 flex-shrink-0">
        <button
          ...
          className="text-white active:bg-white/20 rounded-full p-2 transition-colors"
        >
        ...
        <Button
          variant="ghost"
          size="sm"
          className="text-white border border-white/30 active:bg-white/20 px-3 py-1 rounded-full text-sm"
         ...
         <div className="w-full px-4">
           ...
           <div className="w-full h-1 bg-gray-700 rounded-full mb-6 relative cursor-pointer">
             {(() => {
               ...
               return (
                 <>
                   ...
                   ></div>
                   <div
                     className="absolute h-3 w-3 bg-red-600 rounded-full shadow z-10"
                     style={{
             ...
             <input
               ...
               value={currentTime}
               onChange={handleSeek}
               className="w-full h-full bg-transparent rounded-full cursor-pointer absolute top-0 left-0 opacity-0 z-20"
          ...
          <div className="flex justify-center items-center gap-8">
            {/* Shuffle Icon */}
            <button
              onClick={(e) => { e.preventDefault(); toggleShuffle(); }}
              className={`text-2xl focus:outline-none active:scale-90 transition-transform ${isShuffle ? 'text-red-600' : 'text-white'}`}
              title="Aleatório"
            >
              <svg
                stroke="currentColor"
            ...
            <button
              className="text-white text-3xl focus:outline-none active:scale-90 transition-transform"
            ...
            <button
              className="bg-red-600 active:bg-red-700 rounded-full w-14 h-14 flex items-center justify-center text-white text-2xl focus:outline-none transition-colors shadow-lg active:scale-95"
            ...
            <div className="relative">
              <button
                onClick={(e) => { e.preventDefault(); toggleRepeat(); }}
                className={`text-2xl focus:outline-none active:scale-90 transition-transform ${repeatMode !== 'off' ? 'text-red-600' : 'text-white'}`}
                title="Repetir"
              >
                <svg
                  stroke="currentColor"
