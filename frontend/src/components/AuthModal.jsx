...
// Ícones SVG reutilizáveis (definidos fora do componente para performance)
...
const AuthModal = ({ isOpen, onClose }) => {
    ...
    const handleGoogleSignupConfirm = async () => {
        localStorage.setItem('pendingGoogleSignupType', googleSignupType);
        setShowGoogleSignupTypeModal(false);
        await loginWithGoogle();
    };
