...
import { Plus, Search, ChevronDown, Music, X, Upload, Play, Loader2, Edit, Trash2 } from 'lucide-react';
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative">
                <Button
                  ...
                  className="bg-red-600 hover:bg-red-700 text-white border-0 rounded"
                >
                  {orderOptions.find(o => o.value === orderBy)?.label}
                    ...
                    {orderOptions.map(option => (
                      <div
                        ...
                        className={`px-4 py-2 cursor-pointer hover:bg-gray-100 ${
                          orderBy === option.value ? 'bg-red-600 text-white' : ''
                        }`}
                      >
                        {option.label}
                      </div>
